...
// --- Busca simples via querystring ?search= ---
const searchInputValue = ref<string>(String(route.query.search || ''))
      ...
      <div class="py-5 border-b border-[#E5E7EB]">
        <div class="h-full w-full narrow-container flex items-center justify-between">
          ...
          <form
            ...
            role="search"
            class="max-w-[300px] flex flex-[100%] relative w-full"
            @submit.prevent="enterPress"
          >
            <SfInput
