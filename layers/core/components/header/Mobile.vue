...
<template>
  ...
  >
    <div class="flex items-center justify-between h-full w-full narrow-container">
      ...
      <div>
        <SfButton
          class="block font-body bg-transparent hover:bg-white active:bg-white self-end !pl-0 mr-[4px]"
          type="button"
          :aria-haspopup="true"
        ...
        >
          ...
          >
            ...
            <rect
              width="22"
              height="1.76"
              transform="matrix(-1 0 0 1 22 7.04016)"
              fill="black"
            />
            <rect
              width="22"
            ...
            <rect
              width="22"
              height="1.76"
              transform="matrix(-1 0 0 1 22 14.08)"
              fill="black"
            />
            <rect
              width="22"
        ...
        >
          <div class="flex flex-col h-full">
            <ul class="p-6 px-4 flex flex-col">
              <li
                v-for="category in categoriesForMegaMenu"
                :key="category.id"
              >
                <p>
                  <NuxtLink
